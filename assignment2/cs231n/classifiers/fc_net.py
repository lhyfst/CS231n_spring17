...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
#         middle_output, _ = affine_forward(X, self.params['W1'], self.params['b1'])
#         middle_output, _ = relu_forward(middle_output)
#         middle_output, _ = affine_forward(middle_output, self.params['W2'], self.params['b2'])
...
#                 bn_param['mode'] = mode
        ...
        hidden_layers[0] = X
        for i in list(range(self.num_layers)):
